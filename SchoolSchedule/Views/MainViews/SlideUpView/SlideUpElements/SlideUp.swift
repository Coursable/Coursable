...
struct SlideUp<Content> : View where Content : View {
    ...
    public init(startingOffset: CGFloat = 500, endingOffset: CGFloat = 100, backgroundColor: Color = .white, barColor: Color = .secondary, content: @escaping () -> Content) {
    ...
    public var body: some View {
        ModifiedContent(content: self.content(), modifier: SlideUpViewModifier(startingOffset: startingOffsetValue, endingOffset: endingOffsetValue, backgroundColor: backgroundColorValue, barColor: barColorValue))
    }
}
